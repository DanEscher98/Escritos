...
\title{Primavera Carmesí} % Book title
\author{Berry Tart} % Author
...
\ThisCenterWallPaper{1.12}{acuarela.jpg} % Add the background image, the first argument is the scaling - adjust this as necessary so the image fits the entire page
...
%----------------------------------------------------------------------------------------
\tableofcontents
\markdownInput{Chapters/preface.md}

\foreach \N in {1,...,14}{
    \markdownInput{Chapters/ch-\N.md}
}
